...
if __name__ == '__main__':
    ...
    #     print(img_name)
    #     image_path = dataset_folder + img_name
    #     print(image_path)
    ...
    #         # save image
    #         print(max_matrix)
    #         #cv2.rectangle(img_raw, (max_matrix[0], max_matrix[1]), (max_matrix[2], max_matrix[3]), (0, 0, 255), 2)
    #         # img_crop = img_raw[max_matrix[0] - 10:max_matrix[2] - 10, max_matrix[1] + 10:max_matrix[3] + 10]
    #         left = max_matrix[1] - 30 if max_matrix[1] >= 30 else 0
    #         right = max_matrix[0] - 30 if max_matrix[0] >= 30 else 0
    #         img_crop = img_raw[left:max_matrix[3] + 30, right:max_matrix[2] + 30]
    #         # img_crop = img_raw[b[0]:b[1], b[2]:b[3]]
    #         if not os.path.exists("./kaggleData/waitan2024_deepfake_challenge/phase1/valset_process/"):
    #             os.makedirs("./kaggleData/waitan2024_deepfake_challenge/phase1/valset_process/")
    #         name = "./kaggleData/waitan2024_deepfake_challenge/phase1/valset_process/" + img_name

    #         img_crop = cv2.resize(img_crop, (224,224))

    #         cv2.imwrite(name, img_crop)
    img_raw = cv2.imread("img/1.jpg", cv2.IMREAD_COLOR)
    crop_img = generateBooxImg(img_raw)
    # cv2.imshow("Demo3",crop_img)
    # key = cv2.waitKey(0)
    print(type(crop_img))
